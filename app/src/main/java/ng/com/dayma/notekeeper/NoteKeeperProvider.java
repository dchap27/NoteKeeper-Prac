...
import ng.com.dayma.notekeeper.NoteKeeperProviderContract.Courses;
import ng.com.dayma.notekeeper.NoteKeeperProviderContract.CoursesIdColumns;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    // with no AUTHORITY OR a PATH return no match
    ...
    static {
        ...
        // uri matcher to support row ids
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatch){
            case COURSES:
                ...
                break;
            case NOTES:
                // mimeType that returns multiple rows
            ...
            case NOTES_EXPANDED:
                ...
                break;
            case COURSES_ROW:
                // mimeype that returns single row
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            ...
            case NOTES_EXPANDED:
                // throw exception that this is a read-only table
                break;
    ...
    public boolean onCreate() {
        mDbOpenHelper = new NoteKeeperOpenHelper(getContext()); // create a connection to the database
        return true;
    }
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection,
        ...
        // To ensure that when ._ID column is requested, issue the database query qualified by note_info table

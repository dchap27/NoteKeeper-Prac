...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_TITLE = "ng.com.dayma.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "ng.com.dayma.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "ng.com.dayma.notekeeper.extra.NOTE_ID";

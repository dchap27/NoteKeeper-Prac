...
//        NoteReminderNotification.notify(this, noteTitle, noteText, noteId);
        ...
        long ONE_HOUR = 60 * 60 * 1000; // convert one hour to milliseconds
        long TEN_SECONDS = 10 * 1000;
        long alamTime = currentTimeInMilliseconds + TEN_SECONDS;

        alarmManager.set(AlarmManager.ELAPSED_REALTIME, alamTime, pendingIntent);
    }
    ...
    private CursorLoader createLoaderCourses() {
        ...
        // create the uri for the content provider to load courses from the content provider
